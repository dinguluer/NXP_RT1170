...
//#define RIDER_SELECT_SCREEN_FONT lv_font_simsun_20


#define RIDER_SELECT_SCREEN_FONT lv_font_Alatsi_Regular_20
...
void setup_scr_rider_selected_screen(lv_ui *ui){
	...
	//lv_label_set_text_fmt(ui->rider_selected_screen_label_area, "AREA %c %c %cLIMIT", 32,32,32);
	...
	lv_style_set_text_font(&style_rider_selected_screen_label_area_main_main_default, &RIDER_SELECT_SCREEN_FONT);
	...
	lv_style_set_text_font(&style_rider_selected_screen_label_time_main_main_default, &RIDER_SELECT_SCREEN_FONT);
	...
	lv_style_set_text_font(&style_rider_selected_screen_label_speed_main_main_default, &RIDER_SELECT_SCREEN_FONT);
	...
	lv_obj_set_size(ui->rider_selected_screen_label_mode, 220, 32);
	...
	lv_style_set_text_font(&style_rider_selected_screen_label_mode_main_main_default, &RIDER_SELECT_SCREEN_FONT);
