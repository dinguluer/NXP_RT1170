...
// Howard
// To skip the DCDC checking code, just define SKIP_DCDC_ADJUSTMENT = 1. In line 240 of the clock_config.c file, adding an additional definition for SKIP_DCDC_ADJUSTMENT :
