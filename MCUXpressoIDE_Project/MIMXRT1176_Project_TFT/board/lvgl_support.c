...
// #include "fsl_gt911.h"   //---> touch pannel
...
// Buffer address : set this by calling function as buffer is static variable
// uint32_t bufferAddr;    /*!< Frame buffer address. */
void set_frame_bufferAddr(uint32_t* bufferAddr)
{
...
//    // ELCDIF_RgbModeStart(LCDIF);  // Dinesh  -->  g_dc.ops->enableLayer(&g_dc, 0);  // DC_FB_ELCDIF_EnableLayer  -->  ELCDIF_RgbModeStart & ELCDIF_EnableInterrupts
//    DEMO_InitLcdBackLight(); // Add this function as it is DEMO code of RT1060 TFT eLCDIF code  // --> Dinesh
    ...
    g_dc.ops->enableLayer(&g_dc, 0);  // DC_FB_ELCDIF_EnableLayer  -->  ELCDIF_RgbModeStart
