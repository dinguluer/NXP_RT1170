...
void setup_scr_screen_drawing(lv_ui *ui){
	...
	lv_style_set_bg_color(&style_screen_drawing_main_main_default, lv_color_make(0x25, 0x04, 0x04));
	lv_style_set_bg_opa(&style_screen_drawing_main_main_default, 255);
	...
	//Write codes screen_drawing_canvas_1
	ui->screen_drawing_canvas_1 = lv_canvas_create(ui->screen_drawing_container_drawing);
	lv_obj_set_pos(ui->screen_drawing_canvas_1, 400, 400);
	lv_obj_set_size(ui->screen_drawing_canvas_1, 100, 40);

	//Write style state: LV_STATE_DEFAULT for style_screen_drawing_canvas_1_main_main_default
	static lv_style_t style_screen_drawing_canvas_1_main_main_default;
	if (style_screen_drawing_canvas_1_main_main_default.prop_cnt > 1)
		lv_style_reset(&style_screen_drawing_canvas_1_main_main_default);
	else
		lv_style_init(&style_screen_drawing_canvas_1_main_main_default);
	lv_style_set_img_recolor(&style_screen_drawing_canvas_1_main_main_default, lv_color_make(0x00, 0x00, 0x00));
	lv_style_set_img_recolor_opa(&style_screen_drawing_canvas_1_main_main_default, 0);
	lv_obj_add_style(ui->screen_drawing_canvas_1, &style_screen_drawing_canvas_1_main_main_default, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_color_t *buf_screen_drawing_canvas_1 = (lv_color_t*)lv_mem_alloc(100*40*4);
	lv_canvas_set_buffer(ui->screen_drawing_canvas_1, buf_screen_drawing_canvas_1, 100, 40, LV_IMG_CF_TRUE_COLOR_ALPHA);
	lv_canvas_fill_bg(ui->screen_drawing_canvas_1, lv_color_make(0x00, 0x00, 0x00), 0);
	...
	lv_style_set_text_font(&style_screen_drawing_rpm_18_main_main_default, &lv_font_simsun_16);
	...
	lv_style_set_text_font(&style_screen_drawing_rpm_17_main_main_default, &lv_font_simsun_16);
	...
	lv_style_set_text_font(&style_screen_drawing_rpm_16_main_main_default, &lv_font_simsun_16);
	...
	lv_style_set_text_font(&style_screen_drawing_rpm_15_main_main_default, &lv_font_simsun_16);
	...
	lv_style_set_text_font(&style_screen_drawing_rpm_14_main_main_default, &lv_font_simsun_16);
	...
	lv_style_set_text_font(&style_screen_drawing_rpm_13_main_main_default, &lv_font_simsun_16);
	...
	lv_style_set_text_font(&style_screen_drawing_rpm_12_main_main_default, &lv_font_simsun_16);
	...
	lv_style_set_text_font(&style_screen_drawing_rpm_11_main_main_default, &lv_font_simsun_16);
	...
	lv_style_set_text_font(&style_screen_drawing_rpm_10_main_main_default, &lv_font_simsun_16);
	...
	lv_style_set_text_font(&style_screen_drawing_rpm_9_main_main_default, &lv_font_simsun_16);
	...
	lv_style_set_text_font(&style_screen_drawing_rpm_8_main_main_default, &lv_font_simsun_16);
	...
	lv_style_set_text_font(&style_screen_drawing_rpm_7_main_main_default, &lv_font_simsun_16);
	...
	lv_style_set_text_font(&style_screen_drawing_rpm_6_main_main_default, &lv_font_simsun_16);
	...
	lv_style_set_text_font(&style_screen_drawing_rpm_5_main_main_default, &lv_font_simsun_16);
	...
	lv_style_set_text_font(&style_screen_drawing_rpm_4_main_main_default, &lv_font_simsun_16);
	...
	lv_style_set_text_font(&style_screen_drawing_rpm_3_main_main_default, &lv_font_simsun_16);
	...
	lv_style_set_text_font(&style_screen_drawing_rpm_2_main_main_default, &lv_font_simsun_16);
	...
	lv_style_set_text_font(&style_screen_drawing_rpm_1_main_main_default, &lv_font_simsun_16);
	...
	lv_style_set_text_font(&style_screen_drawing_rpm_0_main_main_default, &lv_font_simsun_16);
	...
	lv_style_set_text_font(&style_screen_drawing_gear_label_main_main_default, &lv_font_simsun_14);
	...
	lv_label_set_text(ui->screen_drawing_Gear_value_label, "2");
	...
	lv_style_set_text_font(&style_screen_drawing_gear_value_label_main_main_default, &lv_font_simsun_80);
	...
	lv_obj_set_pos(ui->screen_drawing_speed_value_label, 518, 190);
	lv_obj_set_size(ui->screen_drawing_speed_value_label, 262, 90);
	lv_label_set_text(ui->screen_drawing_speed_value_label, "865");
	...
	lv_style_set_text_font(&style_screen_drawing_speed_value_label_main_main_default, &lv_font_DSEG7Classic_Regular_80);
	...
	lv_obj_set_pos(ui->screen_drawing_speed_unit_label, 596.6666666666667, 274);
	...
	lv_style_set_text_font(&style_screen_drawing_speed_unit_label_main_main_default, &lv_font_simsun_15);
	...
	lv_obj_set_pos(ui->screen_drawing_RPM_value_label, 15, 190);
	lv_obj_set_size(ui->screen_drawing_RPM_value_label, 262, 90);
	lv_label_set_text(ui->screen_drawing_RPM_value_label, "450");
	...
	lv_style_set_text_font(&style_screen_drawing_rpm_value_label_main_main_default, &lv_font_DSEG7Classic_Regular_80);
	...
	lv_obj_set_pos(ui->screen_drawing_RPM_UNIT_label, 95, 274);
	...
	lv_style_set_text_font(&style_screen_drawing_rpm_unit_label_main_main_default, &lv_font_simsun_15);
	...
	lv_style_set_text_font(&style_screen_drawing_time_level_drawing_1_main_main_default, &lv_font_simsun_20);
	...
	lv_style_set_text_font(&style_screen_drawing_time_level_drawing_0_main_main_default, &lv_font_simsun_20);
	...
	lv_style_set_text_font(&style_screen_drawing_time_level_drawing_main_main_default, &lv_font_simsun_20);
	...
	lv_style_set_text_font(&style_screen_drawing_date_label_drawing_2_main_main_default, &lv_font_simsun_20);
	...
	lv_style_set_text_font(&style_screen_drawing_date_label_drawing_1_main_main_default, &lv_font_simsun_20);
	...
	lv_style_set_text_font(&style_screen_drawing_date_label_drawing_0_main_main_default, &lv_font_simsun_20);
	...
	lv_style_set_text_font(&style_screen_drawing_date_label_drawing_main_main_default, &lv_font_simsun_20);
	...
	lv_obj_set_pos(ui->screen_drawing_arc_indicator, 264, 86);
	...
	lv_style_set_arc_width(&style_screen_drawing_arc_indicator_main_main_default, 12);
	...
	lv_style_set_arc_width(&style_screen_drawing_arc_indicator_main_indicator_default, 12);
	...
	lv_style_set_bg_opa(&style_screen_drawing_arc_indicator_main_knob_default, 81);
	...
	lv_style_set_text_font(&style_screen_drawing_fuel_empty_label_main_main_default, &lv_font_simsun_14);
	...
	lv_style_set_text_font(&style_screen_drawing_fuel_full_label_main_main_default, &lv_font_simsun_14);
